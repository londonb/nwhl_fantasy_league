...
SELECT pg_catalog.setval('gms_id_seq', 17, true);
...
SELECT pg_catalog.setval('gms_leagues_id_seq', 27, true);
...
SELECT pg_catalog.setval('gms_leagues_teams_id_seq', 27, true);
...
8	Awesome League	8	1	19
1	UK Hockey	8	2	10
7	Chronic Fire	8	2	8
4	Hawaii Rocks	8	2	3
5	BadT	8	4	8
2	Awesomesauce	8	3	4
9	The Shiva	8	2	1
\.
...
SELECT pg_catalog.setval('leagues_id_seq', 10, true);
...
SELECT pg_catalog.setval('players_teams_id_seq', 114, true);
...
SELECT pg_catalog.setval('rosters_id_seq', 570, true);
...
11	Wizards	8	6	10
12	The Nappers	8	7	11
14	Brad's Team	8	8	5
13	PowderPuck Girls	8	8	4
25	tyler's team	8	4	17
24	The Pucks	8	4	16
16	Hula	8	7	2
15	Hadrian	8	7	1
19	High Roller	8	8	12
20	bob's team	8	7	13
18	Red Eye Roaches	8	7	12
22	Team of Awesomeness	8	1	14
23	GRand Hoosier	8	1	15
21	Killers	8	1	4
\.
...
SELECT pg_catalog.setval('teams_id_seq', 27, true);
